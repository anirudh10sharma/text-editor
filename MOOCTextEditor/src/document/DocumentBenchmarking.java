...
public class DocumentBenchmarking {
	...
	public static void main(String [] args) {
		...
		{   System.out.print(numToCheck+"\t\t");
			...
			double bc =new BasicDocument(getStringFromFile(textfile,numToCheck)).getFleschScore();
			long endTime = System.nanoTime();
			System.out.print(((endTime-startTime)/1000000) +"\t\t");
			// file to create both a BasicDocument and an EfficientDocument.  
			long startTime1 = System.nanoTime();
			double ec =new EfficientDocument(getStringFromFile(textfile,numToCheck)).getFleschScore();
